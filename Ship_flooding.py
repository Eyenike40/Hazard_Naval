...
def conventional_risk():
    ...
    hazard_file = st.file_uploader("Upload the 'Ship Flooding Hazard' file", type=['xlsx'])
    consequence_file = st.file_uploader("Upload the 'Ship Flooding Consequence' file", type=['xlsx'])
    st.write("")
    st.write("")
    ...
    if hazard_file and consequence_file:
        ...
        hazards = [
            ...
            "Cabinet Leakage due to chemical attack",
        ...
        st.write("#### Risk Score For Hazards for Ship Flooding Accident")
        ...
        ax.set_xticklabels(["SFWI1", "SFWI2", "SFWI3", "SFWI4", "SFWI5", "SFWI6"])
