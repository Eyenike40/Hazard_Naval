...
def conventional_risk():
    ...
    hazard_file = st.file_uploader("Upload the 'Mooring Operation Hazard' file", type=['xlsx'])
    consequence_file = st.file_uploader("Upload the 'Mooring Operation Consequence' file", type=['xlsx'])
    st.write("")
    st.write("")
    ...
    if hazard_file and consequence_file:
        ...
        st.write("#### Risk Score For Hazards for Mooring Operation Accident")
        ...
        ax.set_xticklabels(["MOA1", "MOA2", "MOA3", "MOA4", "MOA5", "MOA6", "MOA7", "MOA8", "MOA9", "MOA10", "MOA11"])
