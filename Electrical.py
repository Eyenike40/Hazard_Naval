...
def conventional_risk():
    ...
    hazard_file = st.file_uploader("Upload the 'Electrical Hazard' file", type=['xlsx'])
    consequence_file = st.file_uploader("Upload the 'Electrical Consequence' file", type=['xlsx'])
    st.write("")
    st.write("")
    ...
    if hazard_file and consequence_file:
        ...
        st.write("#### Risk Score For Hazards for Electrical Accident")
        ...
        ax.set_xticklabels(["EA1", "EA2", "EA3", "EA4", "EA5", "EA6", "EA7", "EA8", "EA9", "EA10", "EA11", "EA12"])
